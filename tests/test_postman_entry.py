...
def test_postman_entry():
    postman_entry = PostmanEntry(os.path.join("../", "samples", "Postman Echo.postman_collection.json"))
...
def test_entry_repr():
    postman_entry = PostmanEntry.create(os.path.join("../", "samples", "Postman Echo.postman_collection.json"))
